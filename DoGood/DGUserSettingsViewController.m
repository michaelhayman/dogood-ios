...
- (void)viewDidAppear:(BOOL)animated {
    ...
    // watch keyboard
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(didSignOut:) name:DGUserDidSignOutNotification object:nil];
