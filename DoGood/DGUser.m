...
+ (DGUser*)currentUser {
	if (nil == currentUser) {
		...
		if (userID) {
            ...
            currentUser.rank = [defaults objectForKey:kDGUserCurrentUserRank];
...
+ (void) assignDefaults {
	...
	[[NSUserDefaults standardUserDefaults] setObject:currentUser.points forKey:kDGUserCurrentUserPoints];
	[[NSUserDefaults standardUserDefaults] setObject:currentUser.rank forKey:kDGUserCurrentUserRank];
...
- (void)signOutWithMessage:(BOOL)showMessage {
    ...
    [[NSUserDefaults standardUserDefaults] setValue:nil forKey:kDGUserCurrentUserRank];
    ...
    self.points = nil;
    self.rank = nil;
    self.nominations_for_user_goods_count = nil;
